 ...
 <header class="masthead">
        ...
        <div class="container">
        	...
        	<div class="col-lg-8">
        		<div class="sticky">
	        		<div class="card">
	        			<div class="card-body">
	        				<div class="row">
		        				<div class="col-md-8"><b>Товары</b></div>
		        				<div class="col-md-4 text-right"><b>Всего</b></div>
	        				</div>
	        			</div>
	        		</div>
	        	</div>
	        		...
	        		<div class="card-body">
		        		<div class="row">
			        		...
			        		<div class="col-md-4">
			        			...
			        			<p> <b><small>Цена :<?php echo number_format($row['price'],2) ?></small></b></p>
			        			<p><small>Количество :</small></p>
        	...
        	<div class="col-md-4">
        		<div class="sticky">
        			<div class="card">
        				<div class="card-body">
        					<p><large>Всего</large></p>
        					<hr>
        					<p class="text-right"><b><?php echo number_format($total,2) ?></b></p>
        					<hr>
        					<div class="text-center">
        						<button class="btn btn-block btn-outline-dark" type="button" id="checkout">Оформить заказ</button>
        					</div>
        				</div>
        			</div>
        		</div>
    ...
    <script>
        ...
        var button = document.querySelector('.qty-plus');

        // Добавляем обработчик события клика на кнопку
        button.addEventListener('click', function() {
            // Вызываем функцию для обновления страницы
            location.reload();
        });

            // Находим кнопку по классу
            var button = document.querySelector('.qty-minus');
